...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const allArtists = [
    ...
    { name: "Aretha Franklin", image: "Images/Aretha Franklin.jpg" },
    ...
    { name: "Calvin Harris", image: "Images/Calvin Harris.jpg" },
    { name: "Carrie Underwood", image: "Images/Carrie Underwood.jpg" },
    { name: "Daft Punk", image: "Images/Daft Punk.jpg" },
    { name: "Dua Lipa", image: "Images/Dua Lipa.jpg" },
    { name: "Elton John", image: "Images/Elton John.jpg" },
    ...
    { name: "Ludovico Einuidi", image: "Images/Ludovico Einuidi.jpg" },
    { name: "Luke Bryan", image: "Images/Luke Bryan.jpg" },
    { name: "Marconiunion", image: "Images/Marconiunion.jpg" },
    { name: "Maxrichtermusic", image: "Images/Maxrichtermusic.jpg" },
    { name: "Michael Jackson", image: "Images/Michael Jackson.jpg" },
    { name: "Mile Davis", image: "Images/Mile Davis.jpg" },
    ...
    { name: "The Wiggles", image: "Images/The Wiggles.jpg" },
